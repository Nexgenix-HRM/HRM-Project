...
const UserManagement = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert(error.response?.data?.message || error.message || 'Error creating employee');
        }
    };
    ...
    return (
        <div className="p-4 lg:p-8 max-w-6xl mx-auto">
            ...
            <div className="flex items-center justify-between gap-4 mb-6">
                <header>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Employee Registry Alpha</p>
                        </div>
                    </div>
                </header>
                ...
                >
                    {showAddForm ? (
                        <>Cancel Operation <FaTimes size={10} /></>
                    ) : (
                        <>New Employee <FaUserPlus size={12} /></>
                    )}
                </button>
            </div>
            ...
            {showAddForm && (
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200/50 p-6 lg:p-8 mb-6 animate-in fade-in slide-in-from-top-4">
                    <div className="flex items-center gap-2.5 mb-6">
                        ...
                        <h3 className="text-base font-bold text-slate-900">Define Employee Profile</h3>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="w-full h-10 px-4 bg-slate-50 border border-slate-200 rounded-xl flex items-center text-[11px] font-bold text-slate-500 cursor-not-allowed">
                                    Field Agent (Employee)
                                </div>
                            </div>
                            <div className="space-y-1">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-slate-200/50 overflow-hidden">
                <div className="p-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/30">
                    <div>
                        ...
                        <p className="text-[9px] text-slate-400 mt-0.5 font-bold uppercase tracking-widest">Personnel status verified</p>
                    </div>
                </div>
                ...
                <div className="overflow-x-auto">
                    ...
                    {users.filter(u => u.role === 'employee').length > 0 ? (
                        <>
                            <div className="px-6 py-3 bg-emerald-50/30 border-b border-emerald-100">
                        ...
                        <div className="p-8 text-center text-slate-400 font-bold uppercase tracking-widest text-[10px]">
                            No personnel records found in this sector.
                        </div>
                    )}
                </div>
            </div>
